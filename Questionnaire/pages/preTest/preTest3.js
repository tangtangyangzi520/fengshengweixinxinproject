...
Page({
  ...
  onStartTest: function () {
    ...
    wx.redirectTo({
      url: '/pages/test/test3?topicId=' + topicId + '&title=' + this.data.title,
    })
  ...
  onShareAppMessage: function () {
    return {
      ...
      path: '/pages/preTest/preTest3?topicId=' + this.data.topicId + '&title=' + this.data.title,
